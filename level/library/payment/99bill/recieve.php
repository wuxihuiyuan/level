	...
	if ($ok == 1) { 
		switch($_REQUEST[payResult]){
				case '10':
						...
						$rtnUrl="http:///index.php?mod=member&act=payment&get=return&type=99bill&msg=success";
						break;
				default:
						$rtnOK=1;
						//以下是我们快钱设置的show页面，商户需要自己定义该页面。
						$rtnUrl="http:///index.php?mod=member&act=payment&get=return&type=99bill&msg=false";
						break;	
						...
						$rtnOK=1;
						//以下是我们快钱设置的show页面，商户需要自己定义该页面。
						$rtnUrl="http:///index.php?mod=member&act=payment&get=return&type=99bill&msg=error";
