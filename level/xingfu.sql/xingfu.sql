...
(1,  '[人脉网络]会员结构', 'member_treeform_arrange', 0, 'treeform', 10001),
(2,  '[人脉网络]推荐列表', 'member_treeform_record', 0, 'treeform', 10002),
(3,  '[人脉网络]推荐结构', 'member_treeform_referee', 0, 'treeform', 10003),
(4,  '[人脉网络]会员注册', 'member_treeform_register', 0, 'treeform', 10004),
(5,  '[人脉网络]会员升级', 'member_treeform_upgroup', 0, 'treeform', 10008),
(10, '[财务管理]资金明细', 'member_capital_list', 0, 'capital', 10010),
(13, '[后台用户]修改密码', 'admin_manager_password', 1, 'manager', 10013),
(14, '[后台用户]用户角色', 'admin_manager_group', 1, 'manager', 10014),
(15, '[后台用户]用户管理', 'admin_manager_control', 1, 'manager', 10015),
(16, '[网站基础]单页管理', 'admin_site_about', 1, 'site', 10016),
(17, '[网站基础]新闻管理', 'admin_site_news', 1, 'site', 10017),
(19, '[网站会员]会员级别', 'admin_user_group', 1, 'user', 10019),
(20, '[网站会员]会员管理', 'admin_user_control', 1, 'user', 10020),


(21, '[系统管理]数据维护', 'admin_main_database', 1, 'main', 10021),
(22, '[系统管理]内部信件', 'admin_main_guestbook', 1, 'main', 10022),
(23, '[系统管理]网站设置', 'admin_main_config', 1, 'main', 10023),
(24, '[系统管理]系统信息', 'admin_main_system', 1, 'main', 10024),
(25, '[账户设置]修改密码', 'member_user_password', 0, 'user', 10025),
(26, '[账户设置]基本信息', 'member_user_profile', 0, 'user', 10026),

(27, '[账户设置]邮箱验证', 'member_user_authemail', 0, 'user', 10027),
(28, '[账户设置]地址管理', 'member_user_address', 0, 'user', 10028),
(29, '[账户设置]手机绑定', 'member_user_authphone', 0, 'user', 10029),
(30, '[会员中心]系统首页', 'member_main_index', 0, 'main', 10030),
(31, '[会员中心]系统公告', 'member_notice_', 0, 'main', 10031),
(32, '[会员中心]站内信件', 'member_imessage_', 0, 'main', 10032),
(33, '[数据统计]资金明细', 'admin_census_money', 1, 'census', 10033),
(34, '[数据统计]提现记录', 'admin_census_atmlog', 1, 'census', 10034),
(35, '[数据统计]充值记录', 'admin_census_payorder', 1, 'census', 10035),
(36, '[产品中心]产品订购', 'member_goods_list', 0, 'goods', 10036),
(37, '[产品中心]购买订单', 'member_goods_order', 0, 'goods', 10037),
(38, '[产品中心]发货订单', 'member_goods_sendorder', 0, 'goods', 10038),
(39, '[账户设置]银行卡管理', 'member_user_bankinfo', 0, 'user', 10039),
(40, '[订货管理]商品订货', 'member_store_detail', 0, 'store', 10040),
(41, '[订货管理]我的订货', 'member_store_list', 0, 'store', 10041),
(42, '[订货管理]下级订货', 'member_store_childlist', 0, 'store', 10042)，
(43, '[积分商城]产品订购', 'member_jfgoods_list', 0, 'jfgoods', 10043),
(44, '[积分商城]购买订单', 'member_jfgoods_order', 0, 'jfgoods', 10044),
(45, '[积分商城]发货订单', 'member_jfgoods_sendorder', 0, 'jfgoods', 10045);
-- --------------------------------------------------------
