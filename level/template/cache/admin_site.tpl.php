...
<div class="headbar clearfix">
  <ul class="tab">
    <li <? if(!$_GET['typeid']) { ?>class="selected"<? } ?>><a href="<?=Purl("?mod=admin&act=site&get=news"); ?>" hidefocus="true">全部分类</a></li>
    <? if(is_array($this->getnewstype(10))) { foreach($this->getnewstype(10) as $val) { ?>    <? $selected = $_GET['typeid']==$val['id'] ? 'class="selected"' : ""; ?>    <li <?=$selected?>><a href="<?=Purl("?mod=admin&act=site&get=news&typeid=".$val['id']); ?>" hidefocus="true"><?=$val['typename']?></a></li>
    <? } } ?>    
    <div class="tabright">
      <form method="get" action="">
        ...
        发布时间：<?=config::form('time',$this->t['str'],'datas');?>
...
<form method="post" action="">
  <table border="0" cellspacing="2" cellpadding="4" class="list" name="table" id="table" width="100%">
    ...
    <? if(is_array($this->newslist)) { foreach($this->newslist as $value) { ?>    <tbody id="remove_<?=$value['id']?>">
      <tr class="trhover">
        ...
        <td align="center"><a href="<?=$value['editurl']?>"><img src="<?=$this->tempdir?>images/icon_edit.gif" title="编辑"/></a> <?=config::form($value['id'],'确认要删除该分类吗','remove');?> </td>
      </tr>
    </tbody>
    <? } } ?>  </table>
    ...
    <table border="0" cellspacing="2" cellpadding="4" class="list" name="table" id="table" width="100%">
      <tbody>
        ...
        <tr class="trhover">
          ...
          <td> <?=config::form('content',$this->news['content'],'editor','0','<1@1>','news');?> </td>
        </tr>
      </tbody>
    </table>
  </div>
...
<form method="post" action="" onsubmit="return sinAlert('确认要对所有分类进行修改操作吗？');">
  <table border="0" cellspacing="2" cellpadding="4" class="list" name="table" id="table" width="100%">
    ...
    <tbody id="type">
      <? if(is_array($this->typelist)) { foreach($this->typelist as $value) { ?>      <tr class="trhover" id="remove_<?=$value['id']?>">
...
<div class="headbar clearfix">
  <ul class="tab">
    <li <? if(!$_GET['typeid']) { ?>class="selected"<? } ?>><a href="<?=Purl("?mod=admin&act=site&get=about"); ?>" hidefocus="true">全部分类</a></li>
    <? if(is_array($this->getabouttype(10))) { foreach($this->getabouttype(10) as $val) { ?>    <? $selected = $_GET['typeid']==$val['id'] ? 'class="selected"' : ""; ?>    <li <?=$selected?>><a href="<?=Purl("?mod=admin&act=site&get=about&typeid=".$val['id']); ?>" hidefocus="true"><?=$val['typename']?></a></li>
    <? } } ?>    
    <div style="clear:both;"></div>    
  </ul>
</div>
<form method="post" action="" onsubmit="return sinAlert('确认批量删除选中的所有信息吗？');">
  <table border="0" cellspacing="2" cellpadding="4" class="list" name="table" id="table" width="100%">
    ...
    <? if(is_array($this->aboutlist)) { foreach($this->aboutlist as $value) { ?>    <tbody id="remove_<?=$value['id']?>">
      <tr class="trhover">
        <td align="center" ><input type="checkbox" name="id[]" value="<?=$value['id']?>"></td>
        <td align="center"><?=$value['id']?></td>
        <td align="center"><?=$value['name']?></td>
        <td align="center"><?=$value['typename']?></td>
        <td align="center"><a href="<?=$value['editurl']?>"><img src="<?=$this->tempdir?>images/icon_edit.gif" title="编辑"/></a> <?=config::form($value['id'],'确认要删除该单页吗','remove');?> </td>
      </tr>
    </tbody>
    <? } } ?>  </table>
  ...
  <div>
    <table border="0" cellspacing="2" cellpadding="4" class="list" name="table" id="table" width="100%">
      <tbody>
        ...
        <tr class="trhover">
          <td class="left">详细内容</td>
          <td> <?=config::form('content',$this->about['content'],'editor','0','<1@1>','about');?> <span class="tipser" id="contenttip">单页的详细内容</span></td>
        </tr>
      </tbody>
    </table>
  </div>
