...
<div class="headbar clearfix">
  <ul class="tab">
    <li <? if($_GET['groupid']=='') { ?>class="selected"<? } ?>><a href="<?=Purl(adminpre()); ?>">全部会员</a></li>
    <? if(is_array($this->getusergoup())) { foreach($this->getusergoup() as $value) { ?>    <? $class = $_GET['groupid']==$value['groupid'] ? 'class="selected"' : '' ?>    <li <?=$class?>><a href="<?=Purl(adminpre().'&groupid='.$value['groupid']); ?>"><?=$value['groupname']?></a></li>
    <? } } ?>    <div class="tabright">
      <form method="get" action="">
        ...
        注册时间：<?=config::form('time',$this->t['str'],'datas');?>
...
<table border="0" cellspacing="2" cellpadding="4" class="list userlist" id="table" width="100%">
  ...
  <? if(is_array($this->userlist)) { foreach($this->userlist as $value) { ?>  <tbody id="remove_<?=$value['uid']?>">
    <tr class="trhover">
      <td align="left"><p><em>会员编号：</em><?=$value['uid']?></p>
        <p><em>会员账号：</em><a href="<?=Purl("?mod=admin&act=user&loginuid=".$value['uid']); ?>" target="_blank"><?=$value['username']?></a></p>
        <p><em>会员级别：</em><?=$value['usergroup']['groupname']?></p>
        <p><em>库存：</em><?=$value['store']?></p>
        </td>
      <td align="left"><p><em>推荐会员：</em><?=$value['referee'] ? $value['referee'] : '顶层'; ?></p>
        <p><em>会员点数：</em><?=$value['point']?></p>
        <p><em>直推人数：</em><?=$value['renumber']?></p></td>
      <td align="left" class="rmb">
        <p><em>分红：</em><?=$value['share_money']?></p>
        <p><em>返点：</em><?=$value['rebate']?></p>
        <p><em>总奖金：</em><?=$value['bonus']?></p>
      </td>
      <td align="left"><p><em>电子邮箱：</em><? if($value['echeck']=='1') { ?><i class="email" title="已验证"></i><? } ?><?=$value['email']?></p>
      ...
      <td align="left" class="checkstatus" id="checkstatus_<?=$value['uid']?>">
        ...
        <? } else { ?>
        <p align="center"><a href="javascript:listTable.status($('#checkstatus_<?=$value['uid']?>'),'<?=$value['uid']?>','1');">开通会员</a></p>
        <p align="center"><a href="javascript:listTable.remove('<?=$value['uid']?>','确定要删除该会员吗？');">删除会员</a></p>
        <? } ?>
      </td>
      <td align="left"><p><em>注册时间：</em><?=formattime($value['regtime']); ?></p>
        <p><em>最后登录：</em><?=formattime($value['lasttime']); ?></p>
        <p><em>可否登录：</em><img onclick="listTable.toggle(this,'canlogin','<?=$value['uid']?>');" src="<?=$this->tempdir?>images/<?=usercheck($value['canlogin']); ?>" /></p></td>
...
<div class="headbar clearfix">
  <ul class="tab">
    <li <? if($_GET['type']=='arrange') { ?>class="selected"<? } ?>><a href="<?=Purl(adminpre()); ?>">会员结构</a></li>
    <div class="tabright">
      <form method="get" action="">
        <input type="hidden" name="mod" id="mod" value="<?=$_GET['mod']?>" />
        <input type="hidden" name="act" id="act" value="<?=$_GET['act']?>" />
...
<table width="100%" align="left" cellpadding="0" cellspacing="0" id="treeform">
  <tr>
    <td><table width="980" border="0" cellspacing="0" cellpadding="0" align="center" style="margin:0 auto;">
        <!--第一层-->
        <tr>
        ...
        <tr>
          <td align="center"><? if(is_array($this->tree['l'])) { ?>
            <table class="t_info" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <th colspan="3"><a href="<?=Purl("?mod=admin&act=user&get=control&re=treeform&uid=".$this->tree['l']['uid']); ?>"><?=$this->tree['l']['username']?></a></th>
              </tr>
              <tr>
            ...
            <table class="t_info" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <th colspan="3"><a href="<?=Purl('?mod=admin&act=user&get=control&re=add&position=left&uid='.$this->tree['uid']); ?>">未注册</a></th>
              </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
              </tr>
          ...
          <td align="center"><? if(is_array($this->tree['c'])) { ?>
            <table class="t_info" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <th colspan="3"><a href="<?=Purl("?mod=admin&act=user&get=control&re=treeform&uid=".$this->tree['c']['uid']); ?>"><?=$this->tree['c']['username']?></a></th>
              </tr>
              <tr>
            ...
            <table class="t_info" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <th colspan="3"><a href="<?=Purl('?mod=admin&act=user&get=control&re=add&position=centre&uid='.$this->tree['uid']); ?>">未注册</a></th>
              </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
              </tr>
          ...
          <td align="center"><? if(is_array($this->tree['r'])) { ?>
            <table class="t_info" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <th colspan="3"><a href="<?=Purl("?mod=admin&act=user&get=control&re=treeform&uid=".$this->tree['r']['uid']); ?>"><?=$this->tree['r']['username']?></a></th>
              </tr>
              <tr>
            ...
            <table class="t_info" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <th colspan="3"><a href="<?=Purl('?mod=admin&act=user&get=control&re=add&position=right&uid='.$this->tree['uid']); ?>">未注册</a></th>
              </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
              </tr>
...
<table border="0" cellspacing="2" cellpadding="4" class="list" name="table" id="table" width="100%">
  ...
  <? if(is_array($this->group)) { foreach($this->group as $value) { ?>  <tbody>
    <tr class="trhover">
      ...
      <td align="center"><a href="<?=Purl("?mod=admin&act=user&get=group&re=edit&groupid=".$value['groupid']); ?>"><img src="<?=$this->tempdir?>images/icon_edit.gif" title="编辑"/></a></td>
    </tr>
  </tbody>
  <? } } ?></table>
...
<!--         <tr onmouseover="this.bgColor='#F5F5F5';" onmouseout="this.bgColor='ffffff';" bgcolor="#ffffff">
          <td class="left">订货返点</td>
          <td><input type="text" name="rebate" id="rebate" value="<?=$this->add['rebate']?>" />元/箱</td>
        </tr>
        <tr onmouseover="this.bgColor='#F5F5F5';" onmouseout="this.bgColor='ffffff';" bgcolor="#ffffff">
          <td class="left">奖金</td>
          <td><input type="text" name="bonus" id="bonus" value="<?=$this->add['bonus']?>" />元/箱</td>
        </tr>
        <tr onmouseover="this.bgColor='#F5F5F5';" onmouseout="this.bgColor='ffffff';" bgcolor="#ffffff">
          <td class="left">分红</td>
          <td><input type="text" name="share_money" id="share_money" value="<?=$this->add['share_money']?>" />元/箱</td>
        </tr> -->
        <tr onmouseover="this.bgColor='#F5F5F5';" onmouseout="this.bgColor='ffffff';" bgcolor="#ffffff">
          <td class="left">级别</td>
        ...
        <tr onmouseover="this.bgColor='#F5F5F5';" onmouseout="this.bgColor='ffffff';" bgcolor="#ffffff">
          <td class="left">是否代理</td>
          <td>
            是：<input type="radio" name="is_agents" id="buy_way" <? if($this->add[is_agents] == "1") { ?> checked <? } ?>  value="1"/>&nbsp;&nbsp;
            否：<input type="radio" name="is_agents" id="buy_way" <? if($this->add[is_agents]== 0) { ?> checked<? } ?>  value="0"/>
          </td>
        </tr>
        <tr onmouseover="this.bgColor='#F5F5F5';" onmouseout="this.bgColor='ffffff';" bgcolor="#ffffff">
          <td class="left">级别权限</td>
          <td class="purviews" height="50">
          <? if(is_array($this->right)) { foreach($this->right as $key=>$val) { ?>            <p style="font-weight:bolder; color:#F00;"><?=$key?>：</p>
  ...
  <tbody>
    <tr bgcolor="#ffffff">
      ...
      <td><form method="get" action="">
          ...
          申请时间：<?=config::form('time',$this->time_str,'datas','');?>
...
<table border="0" cellspacing="2" cellpadding="4" class="list" name="table" id="table" width="100%">
  ...
  <? if(is_array($this->customs)) { foreach($this->customs as $value) { ?>  <tbody>
    <tr class="trhover">
