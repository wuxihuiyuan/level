...
$(function(){
 ...
 $(".orderback").click(function(){
  ...
  var _this = $(this);
    ...
    $("#controlLoad").show();
    removetip("ordersend");
       $.getJSON(listTable.url+'&repass='+$("#repass").val()+'&do=ordersend&id='+id+'&express='+encodeURIComponent($("#express").val())+'&expressnumber='+encodeURIComponent($("#expressnumber").val())+'&mincode='+encodeURIComponent($("#mincode").val())+'&maxcode='+encodeURIComponent($("#maxcode").val()),function(res) {
    $("#controlLoad").hide(); 
         if(res.error == 0){
