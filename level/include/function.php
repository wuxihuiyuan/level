...
function member_menu($key){
   ...
   $menu['goods'] = array('list'=>'代理产品','linlist'=>'零售产品','order'=>'我的订单','sendorder'=>'一级订单');
   $menu['jfgoods'] = array('list'=>'积分产品','linlist'=>'零售产品','order'=>'我的订单','sendorder'=>'一级订单');
...
function admin_menu_top(){
   return array ('main'=>'系统管理','manager'=>'后台用户','user'=>'系统会员','site'=>'网站基础','census'=>'数据统计','shop'=>'产品管理','store'=>'订货管理');
}
function admin_menu_left($top=''){
   ...
   $menu['census'] = array('money'=>'资金明细','atmlog'=>'提现记录','payorder'=>'充值记录');
...
function admin_menu_small($top='',$left=''){
   ...
   $menu['census_payorder'] = array('list'=>'充值记录','chart'=>'充值走势');  
   $menu['shop_goods'] = array('list'=>'产品列表','edit'=>'编辑产品-no',);
