<? if (!defined('ROOT')) exit('Can\'t Access !'); if(is_array($this->member)) { include template('member_header','default/member'); ?>
<div id="main">
<div class="left">
...
<h2><?=$this->message?></h2>
<p>1.网页会自动跳转，如果在5秒钟后仍跳转，请点击
<a href="<?=$this->jcode?>" class="blue">手动跳转</a>
</p>
<p>2.如果你想返回到上一页继续操作，请点击
...
<? include template('member_footer','default/member'); } else { ?>
