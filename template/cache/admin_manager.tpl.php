...
</thead><? if(is_array($this->managerlist)) { foreach($this->managerlist as $value) { ?><tbody id="remove_<?=$value['uid']?>">
...
<span class="tipser" id="usernametip">请输入要使用的用户名</span> <? } else { ?> <?=$this->add['username']?> <? } ?> </td>
</tr>
<tr onmouseover="this.bgColor='#F5F5F5';" onmouseout="this.bgColor='ffffff';" bgcolor="#ffffff">
...
<td align="center">
<a href="<?=Purl(" ?mod=admin&act=manager&get=group&re=edit&groupid=".$value['groupid']); ?>"><img src="<?=$this->tempdir?>images/icon_edit.gif" title="编辑" /></a>
<a href="javascript:delAlert('<?=Purl(" ?mod=admin&act=manager&get=group&id=".$value['groupid']); ?>');"> <img src="<?=$this->tempdir?>images/icon_drop.gif" title="删除" /></a>
</td>
</tr>
</tbody><? } } ?></table>
<? } if($_GET['re']=='add'||$_GET['re']=='edit') { ?>
