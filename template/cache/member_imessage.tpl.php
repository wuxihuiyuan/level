...
<a href="<?=Purl(memberpre(1).'&method=sendfrom'); ?>" class="<?=$_GET['method']=='sendfrom' ? 'menushow' : 'menu'; ?>">收件箱</a>
<a href="<?=Purl(memberpre(1).'&method=sendto'); ?>" class="<?=$_GET['method']=='sendto' ? 'menushow' : 'menu'; ?>">发件箱</a>
<a href="<?=Purl(memberpre(1).'&method=send'); ?>" class="<?=$_GET['method']=='send' ? 'menushow' : 'menu'; ?>">写信件</a>
</div>
...
<td class="title">
<a href="javascript:listTable.message(<?=$value['id']?>);"><img id="mess_<?=$value['id']?>" src="<?=$this->tempdir?>images/message_<?=$value['ico']?>.gif" /><?=$value['title']?></a>
</td>
<td id="read_<?=$value['id']?>"><?=$value['checked']?></td>
<td><?=$value['addtime']?></td>
<td>
<a href="javascript:listTable.memberRemove('<?=$value['id']?>','确定要删除该信件吗');">删除</a>
</td>
</tr><? } } ?></table>
