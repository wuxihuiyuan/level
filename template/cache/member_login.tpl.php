...
<? include template('../common','default/member'); ?>
 <link rel="stylesheet" href="<?=$this->tempdir?>css/login.css" type="text/css" /> <script type="text/javascript" src="<?=$this->tempdir?>js/login.js" ></script>
</head>
...
<tr>
<th></th>
<td><?=config::form('submit','马上登录','submit','','class=\'osLoginIptBtn\'');?>
<a href="<?=Purl('member_forgotpassword')?>">忘记密码？</a>
</td>
</tr>
</table>
</form>
